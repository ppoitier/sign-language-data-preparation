...
if __name__ == "__main__":
    ...
    clean_all_poses_from_tars(
        source_tar_urls="file:F:/datasets/sign-language/dgs/poses/mediapipe/raw/poses_{000000..000178}.tar",
        dest_tar_path="F:/datasets/sign-language/dgs/poses/mediapipe/poses_linear_interpolation.tar",
        show_progress=True,
