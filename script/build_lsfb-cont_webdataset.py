...
from sldp.samples.io import (
    load_continuous_samples_from_annotations,
    load_unannotated_samples_from_poses,
)
...
if __name__ == "__main__":
    ...
    build_sign_language_webdataset(
        samples, n_shards=8, dest_filepath=root + "/shards/annotated/shard_{:0>6}.tar"
    )
